...
class ResCompany(models.Model):
    ...
    sage_path_file_destination = fields.Char("Repertoire fichiers traités")
...
class ResConfigSettings(models.TransientModel):
    ...
    sage_path_file_destination = fields.Char(string="Repertoire fichiers traités", related="company_id.sage_path_file_destination", readonly=False, config_parameter="ftp.file_destination")
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('ftp.file_destination', self.env.user.company_id.sage_path_file_destination)
    ...
    def get_values(self):
        ...
        res['sage_path_file_destination'] = self.env.user.company_id.sage_path_file_destination
